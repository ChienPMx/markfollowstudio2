...
You can ask questions on the [Deepwiki of MarkFlow Studio](https://deepwiki.com/MarkFlow Studio/MarkFlow Studio). It indexes the files in the repository, so you can find answers quickly.

### Basic Steps

First, download the executable file that matches your device system from the [Release](https://github.com/MarkFlow Studio/MarkFlow Studio/releases), then follow the tutorial below to choose between the desktop version or non-desktop version. Place the software download in an empty folder, as running it will generate some directories, and keeping it in an empty folder will make management easier.
...
1. Open the terminal in the directory where the executable file (assuming the file name is MarkFlow Studio_1.0.0_desktop_macOS_arm64) is located
...
1. Open the terminal in the directory where the executable file (assuming the file name is MarkFlow Studio_1.0.0_macOS_arm64) is located
2. Execute the following commands in order:
   ```
